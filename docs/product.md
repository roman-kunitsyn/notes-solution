...
The Notes bot can list and view notes for a linked account in a private
Telegram chat, but it is not yet a supported full Notes CRUD client. Its
remaining scope is create, edit, and delete work.
